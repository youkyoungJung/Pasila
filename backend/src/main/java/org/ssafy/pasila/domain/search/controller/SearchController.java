...
public class SearchController {
    ...
    public List<SearchLiveResponse> getAllResultsForLive(@Parameter String keyword){
        return searchService.searchForLive(keyword);
    }

    @Operation(summary = "Search Shortping", description = "Shortping에 대한 검색기능을 제공합니다.")
    @GetMapping(value="/shortping")
    public List<SearchShortpingResponse> getAllResultsForShortping(@Parameter String keyword){
        return searchService.searchForShortping(keyword);
    }
