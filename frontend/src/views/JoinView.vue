  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <section class="userInfo">
        ...
        <div class="check-text">비밀번호 맞는지 확인하는 텍스트</div>
      </section>
      <section class="userInfo">
        <v-short-input :data="shortData.phone" @getData="(e) => (user.phone = e)" />
      </section>
      <section class="userInfo">
        <v-short-input :data="shortData.phoneCheck" />
        <div class="check-text">인증번호 확인하는 텍스트</div>
      </section>
      <section class="userInfo">
      ...
      <section class="userInfo">
        ...
        <input type="date" value="YYYY/MM/DD" v-model="user.birth" class="birth" />
      </section>
      <div class="join-btn">
...
.container {
  ...
  .content {
    ...
    .profile {
      ...
      .profile-img {
        @include box(3.5rem, 3.5rem, none, 50%, 0, 0);
      }
